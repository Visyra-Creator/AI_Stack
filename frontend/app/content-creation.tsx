...
import { contentCreationStorage, ContentCreationItem } from '@/src/services/storage';
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      {items.length === 0 ? (
        <EmptyState
          icon="create-outline"
          title="No Content Tools"
          description="Track your content creation tools and resources."
