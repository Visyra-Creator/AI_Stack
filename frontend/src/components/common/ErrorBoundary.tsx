 ...
 * Functional component wrapper for React 19 compatibility
 */
export class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorState> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    // Special handling for "Cannot call a class as a function"
    if (error.message.includes('call a class as a function') ||
        error.message.includes('is not a constructor') ||
        error.message.includes('Cannot call a class')) {
      console.error('🔴 COMPONENT INSTANTIATION ERROR DETECTED');
      console.error('This usually means a class component is being used as a function');
      console.error('Check your component imports and default exports');
           ...
           <ScrollView style={styles.errorContainer}>
             ...
             <View style={styles.section}>
               ...
               <Text style={styles.tip}>
                 • Check all component imports - make sure they&apos;re not calling classes as functions
               </Text>
               <Text style={styles.tip}>
             ...
             <Text style={styles.footer}>
               Use SafeText and SafeTextInput components to prevent rendering errors
             </Text>
           </ScrollView>
         </View>
       );
